...
const projects = [
  {
    ...
    description: "A revolutionary healthcare platform that leverages artificial intelligence to provide personalized patient care and streamline medical workflows.",
  ...
  },
  {
    ...
    description: "An intuitive dashboard for monitoring and optimizing renewable energy consumption in smart buildings.",
  ...
  },
  {
    ...
    description: "An innovative learning platform that combines immersive technologies with adaptive learning algorithms.",
